...
<html>
  <head>
    ...
    <title>SFA | San Francisco de Asis</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>SFA</b>Reflectores</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Reflectores</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ortegaestudios.net - Desarrollando Software
